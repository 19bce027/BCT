...
class block_chain:
    ...
    def create_hash(self,previous,data,timestamp) :
        ...
        while check_proof is False:
            ...
            msg = str(previous)+str(data)+timestamp+str(nonce)
    ...
    def create_block(self,previous_hash,msg) :
        ...
        hash_value , nonce = self.create_hash(previous_hash,msg,time_stamp)
        one_block = {
    ...
    #     count = 1
    #     while check_proof is False:
    #         hash_operation = create_hash()
    #         # hash_operation = hashlib.sha256(
    #         #     str(random.randint(100000,99999999)).encode()).hexdigest()
    #         count = count + 1
    ...
    def chain_valid(self, chain):
        ...
        while block_index < len(chain):
            ...
            if block['previous_hash'] != self.create_hash(previous_block['previous_hash'],previous_block['msg'],previous_block['time_stamp'],previous_block['nonce']):
                return False
